/*
Este arquivo tem funções que valida os dados dos usuários,
garante que cada campo não esteja vazio, valida o endereço de e-mail e a senha.
Após a validação, retorna a variável success e o objeto error.
*/
